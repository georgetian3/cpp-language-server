...
def p_class_name(p):
    ...
    class_name : IDENTIFIER
               | simple_template_id
    '''
    p[0] = ExternalNode('class_name', p[1:])
...
def p_class_head(p):
    ...
    '''
    p[0] = ExternalNode('class_head', p[1:])
...
def p_class_head_name(p):
    ...
    '''
    p[0] = ExternalNode('class_head_name', p[1:])

def p_class_virt_specifier(p):
    '''
    class_virt_specifier : FINAL
    '''
    p[0] = ExternalNode('class_virt_specifier', p[1:])
...
def p_class_key(p):
    ...
    class_key : CLASS
              ...
              | UNION
    '''
    p[0] = ExternalNode('class_key', p[1:])
...
def p_member_declarator(p):
    ...
    '''
    p[0] = ExternalNode('member_declarator', p[1:])
...
def p_virt_specifier_seq(p):
    ...
    virt_specifier_seq : virt_specifier
                       | virt_specifier_seq virt_specifier
    '''
    p[0] = ExternalNode('virt_specifier_seq', p[1:])
...
def p_virt_specifier(p):
    ...
    virt_specifier : OVERRIDE
                   | FINAL
    '''
    p[0] = ExternalNode('virt_specifier', p[1:])

def p_pure_specifier(p):
    '''
    pure_specifier : '=' '0'
    '''
    p[0] = ExternalNode('p_pure_specifier', p[1:])

def p_conversion_function_id(p):
    '''
    conversion_function_id : OPERATOR conversion_type_id
    '''
    p[0] = ExternalNode('conversion_function_id', p[1:])
...
def p_base_specifier_list(p):
    ...
    base_specifier_list : base_specifier ellipsis_opt
                        | base_specifier_list ',' base_specifier ellipsis_opt
    '''
    p[0] = ExternalNode('base_specifer_list', p[1:])
...
def p_base_specifier(p):
    ...
    '''
    p[0] = ExternalNode('base_specifier', p[1:])
...
def p_class_or_decltype(p):
    ...
    class_or_decltype : nested_name_specifier_opt type_name
                      ...
                      | decltype_specifier
    '''
    p[0] = ExternalNode('class_or_decltype', p[1:])
...
def p_ctor_initializer(p):
    ...
    '''
    p[0] = ExternalNode('ctor_initializer', p[1:])
...
def p_mem_initializer_list(p):
    ...
    mem_initializer_list : mem_initializer ellipsis_opt
                         | mem_initializer_list ',' mem_initializer ellipsis_opt
    '''
    p[0] = ExternalNode('member_initializer_list', p[1:])
...
def p_mem_initializer(p):
    ...
    mem_initializer : mem_initializer_id '(' expression_list_opt ')'
                    | mem_initializer_id braced_init_list
    '''
    p[0] = ExternalNode('mem_initializer', p[1:])
...
def p_mem_initializer_id(p):
    ...
    mem_initializer_id : class_or_decltype
                       | IDENTIFIER
    '''
    p[0] = ExternalNode('mem_initializer_id', p[1:])